...
var ListService = /** @class */ (function () {
    function ListService(http) {
        this.http = http;
        this.serverApi = 'http://localhost:3000/api/employee';
    }
    ListService.prototype.getAllLists = function () {
        var URI = this.serverApi + "/employeelist";
        return this.http.get(URI)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) { return res.json(); }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) { return res.lists; }));
    };
    ...
    ListService.prototype.addList = function (list) {
        ...
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"];
        var body = JSON.stringify({ empid: list.empid, empname: list.empname, mobile: list.mobile, email: list.email, adress: list.adress, department: list.department, experience: list.experience, skill: list.skill });
        console.log(body);
        headers.append('Content-Type', 'application/json');
...
var ViewListComponent = /** @class */ (function () {
    ...
    ViewListComponent.prototype.deleteList = function (list) {
        var _this = this;
        this.listServ.deleteList(list.empid).subscribe(function (response) { return _this.lists = _this.lists.filter(function (lists) { return lists !== list; }); });
    };
...
module.exports = __webpack_require__(/*! /home/haris/Desktop/employee/employeesdapp/src/main.ts */"./src/main.ts");
